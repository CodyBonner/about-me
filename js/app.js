...
while(correctAnswer !== userGuess){
  userGuess = prompt("Guess a number between 1 and 10 on how many years you think cody has gone to college.");
  ...
  //if userguess does equal answer run condition
    ...
    alert("Ding Ding Ding! You got it, Cody has gone to college for four years!");
    finalScore++;
  }

  //if the attempts turn up at 0, then alert user they ran out of attempts.
  else if (attempts === 0){
    alert("Sorry you are out of attempts! The correct answer was 4 years of college!");
    finalScore--;
    break;
  }
}
